...
defmodule Krakex do
  ...
  ## Example response:
       iex> Krakex.ohlc "BCHEUR", [since: 1575257220, interval: 60]
       {:ok,
       %{
         "XETHZUSD" => [
         [1575255600, "151.02", "151.02", "150.25", "150.30", "150.35",
         "184.89307265", 18]
         ],
         "last" => 1575252000
      }}
  ...
  ## Example:
      ...
      iex> Krakex.depth "bcheur, [count: "4"]
      {:ok,
